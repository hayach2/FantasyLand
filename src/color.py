...
class Color:
    ...
    def get_color(self):
        ...
        # Night to day transition
            ...
            if self.color[0] < self.day_color[0]:
                self.color[0] += self.factor
                self.color[1] += self.factor
                self.color[2] += self.factor
        ...
        # Day to night transition
            ...
            if self.color[0] > self.night_color[0]:
                self.color[0] -= self.factor
                self.color[1] -= self.factor
                self.color[2] -= self.factor
